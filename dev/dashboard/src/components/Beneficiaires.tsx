...
const Beneficiaires = () => {
  ...
  const openModal = (beneficiaire?: Beneficiaire) => {
    if (beneficiaire) {
      ...
      const benevoleId =
        typeof beneficiaire.benevole === "string"
          ? beneficiaire.benevole
          : beneficiaire.benevole?._id || "";
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <select
                  value={formData.benevole}
                  onChange={(e) => setFormData({ ...formData, benevole: e.target.value })}
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-yellow-500 focus:outline-none transition-colors"
                  required
                >
