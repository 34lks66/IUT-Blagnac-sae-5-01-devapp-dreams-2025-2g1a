        ...
        <main className="max-w-5xl mx-auto px-4">
            ...
            <section className="mb-1">
                <div className="grid md:grid-cols-1 gap-15">
                    ...
                    {/* Carte 1 */}
                    <div className="relative bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-l-4 border-b-4 border-red-500 overflow-hidden flex flex-col md:flex-row items-center mr-32">
                    ...
                    {/* Carte 2 */}
                    <div className="relative bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-r-4 border-b-4 border-purple-500 overflow-hidden flex flex-col md:flex-row items-center  ml-32">
                        {/* Image décorative */}
                        <div className="flex items-center justify-center flex-1">
                            <img src={justicelogo} alt="Icône juridique" className="w-32 h-32 md:w-44 md:h-44" />
                        </div>
                        <div className="relative z-10 flex-1">
                            <h3 className="text-xl font-bold mb-3 text-gray-800">Accompagnement juridique</h3>
                            <p className="text-gray-600 mb-4 leading-relaxed text-sm">
                    ...
                    {/* Carte 3 */}
                    <div className="relative bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-l-4 border-b-4 border-blue-500 overflow-hidden flex flex-col md:flex-row items-center  mr-32">
                        <div className="relative z-10 flex-1">
            ...
            <section className="text-center">
                <button
                    className="group relative item card rounded-xl text-center border-t-4 border-t-red-500 bg-white shadow-md px-3 md:px-5 xl:px-40 2xl:px-48 py-3 mb-2 overflow-hidden transition-all duration-400 hover:shadow-lg"
                    onClick={() => {
