      ...
      <section className="bg-[#f5f7f6]">
        <div className="max-w-6xl mx-auto py-7 px-4">
          ...
          <p className="text-base text-gray-700 text-center mx-auto mb-10">Les actions de sensibilisation nous permettent de renforcer la {" "}
            ...
            <span className="text-yellow-600 font-semibold">cohésion</span> autour des enjeux LGBTQIA+. <br />Voici les actions de sensibilisation principales menées par <span className="notranslate" translate="no">DREAMS</span> : </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed border-l-4 border-yellow-500 pl-3">
                Chaque année, <span className="notranslate" translate="no">DREAMS</span> participe avec enthousiasme aux marches des fiertés locales et régionales.
                ...
                4 participations ont déjà permis à <span className="notranslate" translate="no">DREAMS</span> de fédérer ses membres, renforcer ses liens avec d’autres associations, et sensibiliser des centaines de personnes à la cause LGBTQIA+.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed border-l-4 border-yellow-500 pl-3">
                Les soirées de convivialité organisées par <span className="notranslate" translate="no">DREAMS</span> sont des espaces chaleureux où se mêlent échanges, solidarité et bienveillance.
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed border-l-4 border-yellow-500 pl-3">
                Les bénévoles de <span className="notranslate" translate="no">DREAMS</span> sont présents sur les
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed border-l-4 border-yellow-500 pl-3">
                <span className="notranslate" translate="no">DREAMS</span> intervient aussi dans les <b>écoles</b>, <b>entreprises</b>, <b>associations</b> et <b>institutions publiques</b> afin de sensibiliser aux questions d’orientation sexuelle et d’identité de genre.
                ...
                À travers des ateliers participatifs, des échanges et des témoignages, les intervenant·e·s de <span className="notranslate" translate="no">DREAMS</span> contribuent à faire évoluer les mentalités et à prévenir toute forme de discrimination. <br />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed border-l-4 border-yellow-500 pl-3">
                <span className="notranslate" translate="no">DREAMS</span> assure une présence active sur les réseaux sociaux afin de sensibiliser le grand public de manière continue et accessible.
                ...
                Avec plus de 150 publications par an, <span className="notranslate" translate="no">DREAMS</span> amplifie sa mission de sensibilisation et offre un espace d’expression pour toutes les voix de la communauté LGBTQIA+.
              </p>
            </div>
          </div>
        </div>
