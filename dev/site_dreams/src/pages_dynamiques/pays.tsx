...
type ApiCountry = { _id: string; nom: string; description: string; image?: string | null; nomSiege?: string | null; adresse?: string | null; horaire?: string | null; mail?: string | null; number?: string | null; };
...
const Pays: React.FC = () => {
  ...
  return (
    <main className="bg-white text-gray-800 leading-relaxed">
      ...
      {/* BOUTON CONTACT */}
      <div className="max-w-6xl mx-auto my-16 px-6 flex justify-center">
        <a
          href="/contact"
          className="inline-flex items-center justify-center px-8 py-3 text-lg font-bold text-white bg-yellow-600 rounded-lg shadow-md hover:bg-yellow-700 transition-colors duration-200"
        >
          Nous contacter
        </a>
      </div>
