...
*Backlog* : +
    ...
    - https://github.com/34lks66/IUT-Blagnac-sae-5-01-devapp-dreams-2025-2g1a/blob/main/Sprint%20Backlogs/Sprint%200.adoc#objectifs-du-sprint-0[Backlog sprint 0] +
...
|===
.2+| *MEMBRES*       7+| *SÉANCES*
                      | 04/09 (matin) | 10/09 (journée) | 18/09 (journée) | 23/09 (après-mid) | 24/09 (journée) | 25/09 (matin) |
| Léo Guinvarc'h      | P | T | T | T | T | T |
| Mucahit Lekesiz     | P | T | T | T | T | T |
| Loic Phrakousonh    | P | T | T | T | T | T |
| Sidney Richards     | T | T | T | T | T | T |
| Demangel Kilian     | T | T | T | T | T | T |
| Perruffel Bastien   | P | T | T | T | T | T |
|===
