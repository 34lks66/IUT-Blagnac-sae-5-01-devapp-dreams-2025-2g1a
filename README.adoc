...
|===
.2+| *MEMBRES*       5+| *SÉANCES*
                      | 04/09 (matin) | 10/09 (journée) | 18/09 (journée) | 23/09 (après-mid) | 
| Léo Guinvarc'h      | P | T | T | T |
| Mucahit Lekesiz     | P | T | T | T |
| Loic Phrakousonh    | P | T | T | T |
| Sidney Richards     | T | T | T | T |
| Demangel Kilian     | T | T | T | T |
| Perruffel Bastien   | P | T | T | T |
|===
