...
|===
.2+| *MEMBRES*       4+| *SÉANCES*
                      | 04/09 (matin) | 10/09 (journée) | 18/09 (journée) | 
| Léo Guinvarc'h      | P | T | T |
| Mucahit Lekesiz     | P | T | T |
| Loic Phrakousonh    | P | T | T |
| Sidney Richards     | T | T | T |
| Demangel Kilian     | T | T | T |
| Perruffel Bastien   | P | T | T |
|===
